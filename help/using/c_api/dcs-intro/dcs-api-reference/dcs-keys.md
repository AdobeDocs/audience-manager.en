...
uuid: ebbcdec7-0d1e-46e2-9fa5-b1b64b13ba3b
index: y
internal: n
snippet: y
translate: y
...
<table id="table_FCCE4F9D796648899772A191981EFDE6"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Optional. Enabled on customer request. Contact your Adobe Audience Manager consultant or Customer Care. </p> <p>Indicates that traits and segments should be returned inside the JSON response. </p> <p> 
     <ul id="ul_8B936ACB18724681B959783421ACF026"> 
      <li id="li_792A6248F49141C0B4B214C754D5F5C5"> <p> <span class="codeph"> d_cts=1 </span> returns <a href="../../../c_reference/ids-in-aam.md#reference_D55EC67D86664B7499F3257BB870FEC8" format="dita" scope="local"> legacy segment IDs </a> for the segments. </p> </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Returns URL destination data in the JSON response. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Indicates the JSON version to use in the response. Normally, you should set this to <span class="codeph"> d_jsonv=1 </span>. Setting <span class="codeph"> d_jsonv=0 </span> disables ID syncs. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Name Space ID. Indicates which JavaScript container is used. Used by DIL to for id-syncing. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Required if you want a JSON response from the DCS. </p> <p> 
     <ul id="ul_9EA00BD822504BCA8ECB59C1634DB91A"> 
      <li id="li_7CB890F92C4A4C6AA8B4EE32E1AD4564">If you omit this, the DCS returns a pixel in the header. </li> 
      <li id="li_824C23B4C7AA4B5EBADF73D26016A18E">If you include this, the DCS returns a JSON object in the body of the response. See the example below. Your response could be more complex. </li> 
     </ul> </p> <p> 
     <codeblock class="syntax javascript">
       { 
      &nbsp;&nbsp;&nbsp;&nbsp;"stuff":&nbsp;[], 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>SID stands for <span class="term"> score ID </span>. This is a unique ID for a trait or a segment. </p> </td> 
  </tr> 
  <tr> 
   ...
   <td colname="col2"> <p>Passes a data source for trait evaluation. Only traits from this data source are evaluated. </p> <p>For example, say you have: </p> <p> 
     <ul id="ul_6230777E16C14DCB83025A101A4ECA14"> 
      ...
      <li id="li_66125E035F524A958C6F4BFAABA2A0D2">Trait rule: "key1 == val1" </li> 
      <li id="li_4EE486E02CF54AEA876ABC005094E9E4">Data Source ( <a href="../../../c_reference/ids-in-aam.md#reference_D55EC67D86664B7499F3257BB870FEC8" format="dita" scope="local"> DPID </a>): 1 </li> 
     ...
     <ul id="ul_0C30A8AE349D43A08490DA76CB4B06FA"> 
      ...
      <li id="li_1C943F84A4A149A0A86ABC92761D3E9E">Trait rule: "key2 == val2" </li> 
