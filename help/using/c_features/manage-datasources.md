...
uuid: 98eb83af-d5a4-4308-aea2-6c1f5101f75a
index: y
internal: n
snippet: y
translate: y
...
1. Select the check box next to one or more data sources.
   ...
   You can use the [!UICONTROL Search] box to locate the desired data sources if you have a long list. 1. Click  ![](assets/icon_trash.png), then confirm the deletion.
