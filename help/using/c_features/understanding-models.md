...
seo-title: Algorithmic Models  About
solution: Audience Manager
title: Algorithmic Models  About
topic: DIL API
uuid: cec5b6a8-e5a3-43f7-b13e-987083d48094
index: y
internal: n
snippet: y
translate: y
...
# Algorithmic Models: About

A review of algorithmic modeling in Audience Manager. Describes how modeling works, benefits, and workflow.
...
## Understanding TraitWeight {#section_F5164AEE2DCD44C982C93CD01E2E0FA0}
...
## Algorithmic Model Creation and Update Schedule {#section_E420CBD515EC4430BA1F8AED06FD2804}
...
## Models List View {#section_00CF44F40116417AA457878F2E3E65F1}



The list view is a central workspace that helps you to create, review, and manage models. The [!UICONTROL Models] page contains features and tools that help you: 
...
## Models Summary View {#section_398A58E8895643A4810D3FE2F780B3A1}
