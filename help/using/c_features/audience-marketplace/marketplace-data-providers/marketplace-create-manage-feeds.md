...
topic: DIL API
uuid: 3a3fbf55-7c21-44c3-9944-5ad79c6cc280
index: y
internal: n
snippet: y
translate: y
...
1. In [!UICONTROL Plan Types], select the options you want to use and click **[!UICONTROL Add Plan]**.
   ...
   Feeds can contain multiple plans. Plans can contain multiple use cases. For details, see [Plan Types for Data Feeds](../../../c_features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#concept_54DDE4186D0045F386F94BB8C56A5DEA). 1. Click **[!UICONTROL Save]** to save your data fee *without* activating it.
