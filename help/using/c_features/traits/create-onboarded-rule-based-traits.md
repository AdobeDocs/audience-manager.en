...
uuid: 9ea0bd03-6bfe-40f2-ad7e-da8983540ce7
index: y
internal: n
snippet: y
translate: y
...
<wintitle>
  Basic Information
</wintitle> settings let you create new, or edit existing traits. The 
<wintitle>
  Basic Information
</wintitle> settings are the same for rules-based, onboarded and algorithmic traits. To create a new trait, provide a name (avoid special characters), a data source, and select a storage folder. Other 
<wintitle>
  Basic Information
</wintitle> fields are optional. 
<draft-comment>
  c_tb_basics.xml 
</draft-comment>
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>The trait name. Required. </p> <p>Maximum length: 255 characters. </p> <p> <p>Note: When naming traits, avoid these special characters: 
      ...
      </ul> </p> </p> <p>This helps reduce processing errors when you set up an <a href="../../c_integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md#concept_49E6F0740E794B07ACD115D10EDEB5AC" format="dita" scope="local"> inbound data file transfer</a>. </p> </td> 
  </tr> 
  <tr> 
...
<wintitle>
  Advanced Options
</wintitle> lets you set a time-to-live (TTL) interval for a trait. TTL defines how many days a qualified visitor remains in a trait (120 days is default). When set to 0, trait membership never expires. 
