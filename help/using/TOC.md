...
+ Features{#features}
    ...
    + Administration{#administration}
        + [Administration](c-features/administration/administration-overview.md)
        + [Edit Your Account Settings](c-features/administration/edit-account-settings.md)
        + [Usage Limits](c-features/administration/usage-limits.md)
    ...
    + Segments{#segments}
        + [Segments: Purpose, Composition, and Rules](c-features/segments/segments-purpose.md)
        + [Segments List View](c-features/segments/segments-dashboard.md)
        + [Segment Summary View](c-features/segments/segment-summary-view.md)
        + [Retrieving Segment Metadata](c-features/segments/retrieve-segment-metadata.md)
        + [Paused and Deleted Segments](c-features/segments/paused-deleted-segments.md)
        + [Recency and Frequency](c-features/segments/recency-and-frequency.md)
        + [Segment Builder](c-features/segments/segment-builder.md)
        + [Code Syntax Used in the Segment Expression Editor](c-features/segments/segment-code-syntax.md)
        + [Trait and Segment Population Data in Segment Builder](c-features/segments/segment-builder-data.md)
    + Traits{#traits}
...
+ API and SDK Code{#api-and-sdk-code}
    + [API and SDK Code Overview](c-api/api.md)
    ...
    + REST APIs{#rest-apis}
        + [REST APIs Overview](c-api/rest-api-main/c-rest-api-main.md)
        + [Getting Started with REST APIs](c-api/rest-api-main/aam-api-getting-started.md)
        + [Algorithmic API Methods](c-api/rest-api-main/aam-api-algo-methods.md)
        + [Data Integration Library API Methods](c-api/rest-api-main/aam-api-dil-methods.md)
        + [Data Source API Methods](c-api/rest-api-main/aam-api-data-sources.md)
        + [Derived Signals API Methods](c-api/rest-api-main/aam-api-derived-signals.md)
        + Destination API Methods{#destination-api-methods}
            + [Destination API Methods Overview](c-api/rest-api-main/aam-api-destinations/aam-api-destinations.md)
            + [Create Destinations](c-api/rest-api-main/aam-api-destinations/aam-api-create-destinations.md)
            + [Map Segments to a Destination](c-api/rest-api-main/aam-api-destinations/aam-api-map-segments.md)
            + [Return A Destination by Destination ID](c-api/rest-api-main/aam-api-destinations/aam-api-retrieve-destinations.md)
            + [Delete Destinations](c-api/rest-api-main/aam-api-destinations/aam-api-delete-destinations.md)
        + [Domain Management API Methods](c-api/rest-api-main/aam-api-domain-management.md)
        + [Folder API Methods](c-api/rest-api-main/aam-api-folders.md)
        + [Segment API Methods](c-api/rest-api-main/api-segments.md)
        + [Taxonomic API Methods](c-api/rest-api-main/aam-api-taxonomy.md)
        + [Trait API Methods](c-api/rest-api-main/api-traits.md)
        + [Trait Type Methods](c-api/rest-api-main/aam-api-trait-type.md)
        + User, Group, and Permissions Management API Methods{#user-group-permissions}
            + [User Management API Methods](c-api/rest-api-main/aam-api-user-group-permission/aam-api-user.md)
            + [Group Management API Methods](c-api/rest-api-main/aam-api-user-group-permission/aam-api-group.md)
            + [Permissions Management API Methods](c-api/rest-api-main/aam-api-user-group-permission/aam-api-permissions.md)
        + [DCS Region API Methods](c-api/rest-api-main/aam-api-dcs-regions.md)
