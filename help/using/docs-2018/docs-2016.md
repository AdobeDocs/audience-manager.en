...
uuid: 831e13ba-3667-4ac1-9232-ca80d1c7cd07
index: y
internal: n
snippet: y
translate: y
...
<table id="table_D16570793032445FBC18F662BF9DDA7A"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <a href="../c_features/understanding-models.md#concept_1E21CF71FBD04C3EA59554909828DAD5" format="dita" scope="local"> Understanding TraitWeight</a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_dil/dil-use-cases.md#task_3B7B03F0BA834FDDB3DA9452D1F3318D" format="dita" scope="local"> Traffic DIL in Google Tag Manager (GTM) </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_dil/dil-modules.md#reference_FF7F8513BEC5457ABE2902BC854C7C18" format="dita" scope="local"> GA.submitUniversalAnalytics </a> </p> </td> 
...
<table id="table_D83514BA7F5745DA80D6135804D5BD5F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/addressable-audiences.md#concept_E7BFFFB2930D4E7091C1EF9C1FDB9FD0" format="dita" scope="local"> Date Ranges in Addressable Audiences and Destinations </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/destinations/manage-destinations.md#concept_112CF0292676455592FC3A976D7B2F19" format="dita" scope="local"> Destinations Home Page </a> </p> </td> 
...
<table id="table_B19586DBA5D44F8E9D06610DB704EFB9"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <a href="../c_integration/receiving-audience-data/real-time-outbound-transfers/oauth-in-outbound-transfers.md#concept_CA17FEF807BE48D8BAC17243234E50A1" format="dita" scope="local"> OAuth 2.0 Integration for Real-Time Outbound Transfers </a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/understanding-models.md#concept_49FB2DBD4AD041A4ABAAEE9D83BB996E" format="dita" scope="local"> Algorithmic Models </a> </p> </td> 
   <td colname="col2"> <p>Changed title to Algorithmic Models from Models. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#concept_DE8E36D2B96B484482C317DAD20E7F61" format="dita" scope="local"> What Happens After a Provider Deactivates My Data Feed </a> </p> </td> 
   <td colname="col2"> <p>Fixed incorrect header names provided in the deactivation email attachment. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/declared-ids.md#reference_F697F0D53E56430D95EC0C408B767F80" format="dita" scope="local"> Declared ID Variables </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_dil/dil-modules.md#reference_C3DB78CE5C774887AA4FC5629568B651" format="dita" scope="local"> GA.init </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/profile-merge-rules/merge-rule-definitions.md#concept_44FFF67CD9654DB2B43ECA13C2FD1CE0" format="dita" scope="local"> Profile Merge Rule Options Defined </a> </p> </td> 
...
<table id="table_9B18916DD43E4DB38C0C340DE4E3DF62"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../c_dil/dil-overview.md#concept_6E8F5913D2684D54886CB55155081A7B" format="dita" scope="local"> Understanding the Data Integration Library (DIL) </a> </td> 
   <td colname="col2">A general overview of the <span class="wintitle"> Data Information Library</span> (DIL). </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../c_integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md#concept_49E6F0740E794B07ACD115D10EDEB5AC" format="dita" scope="local"> Inbound Data File Contents: Syntax, Invalid Characters, Variables, and Examples </a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_api/api-swagger-migration.md#concept_99C4AEF678E94AFE9B29F9B663200BAD" format="dita" scope="local"> API Code Migration </a> </p> </td> 
...
<table id="table_50CD90671E4B4C50A624AC0948FA8324"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../c_integration/receiving-audience-data/real-time-outbound-transfers/digitally-signed-http-requests.md#concept_1E0F79C0142B4CA38CE03B173022A31C" format="dita" scope="local"> Digitally Signed HTTP Requests </a> </td> 
   <td colname="col2"> <p>A document explaining why and how to encrypt server-to-server HTTP requests. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <a href="../c_features/traits/trait-device-targeting.md#concept_05591A8AF06D4FAB9A32C711D43C56FC" format="dita" scope="local"> Device Targeting With Platform-level Keys </a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_dil/dil-instance-methods.md#concept_F23D61F930874D26AAA136972B0206AC" format="dita" scope="local"> secureDataCollection </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_integration/receiving-audience-data/real-time-outbound-transfers/real-time-outbound-transfers.md#concept_97E489ED9F7B41BBB220D1F55DA9210B" format="dita" scope="local"> Real-Time Outbound Data Transfers </a> </p> </td> 
...
<table id="table_183F245818BC4CF5AAB9B610C1BE4A9F"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/traits/trait-geotarget-keys.md#concept_05591A8AF06D4FAB9A32C711D43C56FC" format="dita" scope="local"> Geotargeting With Platform-level Keys </a> </p> </td> 
...
<table id="table_E71252DF328F42A3AB0BD2CA7DC5A549"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_integration/media-data-integration/impression-data-pixels.md#concept_83852AB68E344D4F8933665C895322C2" format="dita" scope="local"> Capturing Campaign Impression Data via Pixel Calls </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_api/c_rest_api_main/aam-api-getting-started.md#reference_B6E2ECCB46834DF597BBAE3BEBD7BE4D" format="dita" scope="local"> API URLs </a> </p> </td> 
...
<table id="table_106BAD4680F1446B813A907F9E3ADCB8"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/profile-merge-rules/merge-rules-dashboard.md#concept_0D5FDF17A17B400598B787099A48F865" format="dita" scope="local"> Profile Merge Rules Dashboard </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/profile-merge-rules/profile-link-metrics.md#concept_FBA9E3FB4E3C46EE83DB9BD4D288A0CE" format="dita" scope="local"> Report Metrics for Profile Merge Rules </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/destinations/destinations.md#concept_5BDA346C376C4B719EA394108AB2735A" format="dita" scope="local"> Destinations </a> </p> </td> 
...
<table id="table_D4EE56B5AE23497F98025E1D13CBB3A1"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/traits/trait-comparison-operators.md#concept_1A1761AA403341D7B91C0E26DC4294F4" format="dita" scope="local"> Working with Comparison Operators in TraitBuilder </a> </p> </td> 
...
<table id="table_BF1B40564C3C4B569A3B2504ACEEE0E4"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#task_AC7B88F06D1149C39D895C9DFC197F2C" format="dita" scope="local"> Deactivate a Subscriber's Data Feed </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_integration/sending-audience-data/batch-data-transfer-explained/inbound-s3-filenames.md#concept_B3CAF442BFFE4823B76A5D0D91DF9942" format="dita" scope="local"> Amazon S3 Name Requirements for Inbound Data Files </a> </p> </td> 
   <td colname="col2" morerows="1"> <p>Revised content to include syntax for Android and iOS codes in the file names. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_integration/sending-audience-data/batch-data-transfer-explained/inbound-ftp-filenames.md#concept_D34898442363415DBF75CEBFC2E86997" format="dita" scope="local"> FTP Name Requirements for Inbound Data Files </a> </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../c_api/c_rest_api_main/aam-api-getting-started.md#concept_426EEF5C102049B08C8ECF90FCB41796" format="dita" scope="local"> OAuth Authentication </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/visitor-profile-viewer.md#task_768E234139D9498A91B293106939EF4B" format="dita" scope="local"> Visitor Profile Viewer </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/audience-marketplace/marketplace-data-providers/marketplace-billing-report.md#concept_9A1161E52B1D461AAFC7E86225470038" format="dita" scope="local"> Understanding the Data Provider Billing Report </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c_features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#concept_61D21E5C524940FCA28FB5D515C3065D" format="dita" scope="local"> Understanding the Plan Details Page in Audience Marketplace </a> </p> </td> 
