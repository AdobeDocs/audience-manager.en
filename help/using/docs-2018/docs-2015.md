...
uuid: a39d0d4b-1666-452e-b47e-605060db1654
index: y
internal: n
snippet: y
---

# Documentation Updates 2015{#documentation-updates-2015}
...
<table id="table_AC8FF0DB45B546C69D89749FF0FA1CCD"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reference/password-requirements.md#concept_0B501857C23944DCAE4875D3F9455F5F" format="dita" scope="local"> Password Requirements, Locked Accounts, and Forgotten Passwords </a> </p> </td> 
   <td colname="col2"> <p>Revised to include new password requirements. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#concept_E757985A4850400288F1DD9A02B755D5" format="dita" scope="local"> Billing and Impression Allocation for CPM Data Feeds </a> </p> </td> 
   <td colname="col2"> <p>Instructions on how to allocate impressions for different CPM Data Feeds. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#concept_FE781C4C5C044C1F986F1AB6BA4E328F" format="dita" scope="local"> Billing and Impression Allocation for Flat Fee Data Feeds </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/audience-marketplace/marketplace-data-providers/marketplace-create-manage-feeds.md#concept_A31D926BBA0743BCB7160C7F571930FD" format="dita" scope="local"> Discounts for Data Providers </a> </p> </td> 
   <td colname="col2"> <p>Discounts let data providers reduce the price of a data feed for selected buyers. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/audience-marketplace/marketplace-data-buyers/marketplace-manage-subscriptions.md#concept_DB7031710F254277A5297D98A13EFEC9" format="dita" scope="local"> Discounts for Data Buyers </a> </p> </td> 
...
<table id="table_3A725D1D52D24CEAB49B10814008F1C7"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/cid.md#concept_E9DE716F22E8491AB27057DB92B79081" format="dita" scope="local"> CID Replaces DPID and DPUUID </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/declared-ids.md#concept_22E2210AA6604B83B46F5E0CD5504A51" format="dita" scope="local"> URL Variables and Syntax for Declared IDs </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/audience-marketplace/marketplace-private-feeds.md#concept_68EDE94B558C4B88BBCC994B67726FD2" format="dita" scope="local"> Private Data Feeds </a> </p> </td> 
...
<table id="table_A3CAA532BFE7440C93BC11DEF5594D65"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/audience-optimization-reports/metadata-files-intro/metadata-files-intro.md#concept_CD250EF8D3744CC4A722422970886D87" format="dita" scope="local"> Data and Metadata Files for Audience Optimization Reports</a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c-integration/media-data-integration/click-data-pixels.md#concept_E487584D9DBF4D7A8A16B745DAD818CD" format="dita" scope="local"> Capturing Campaign Click Data via Pixel Calls </a> </p> </td> 
   <td colname="col2"> <p>Text revisions and updates. Also, included new key-value pairs required to use and see readable data names in the <span class="wintitle"> Advertising Analytics</span> reports. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_E60674ACBD254365A73AB47FB840A333"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/bulk-management-tools/bulk-management-tools.md#concept_8D6CB301643C482F994938F6484B390C" format="dita" scope="local"> Bulk Management Tools </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <a href="../c-integration/audience-management-module.md#concept_B81EDDFCE607445CB08F1AD6AB7E6F50" format="dita" scope="local"> Implement the Audience Management Module</a> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reference/system-components/components-overview.md#concept_BA514FE94BDE43A4AC8EC3F7AD7A202A" format="dita" scope="local"> System Components </a> </p> </td> 
...
<table id="table_EA3AF6A1987B4EFDBC84F265D5F47DC0"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <a href="../reporting/audience-optimization-reports/aor-advertisers/import-dcm.md#task_5BBF62BBAA7D43AFA6DCCF53C6DBEF00" format="dita" scope="local"> Import DCM Data Files Into Audience Manager</a> </td> 
  ...
  <tr> 
   <td colname="col1"><a href="../c-api/dcs-intro/dcs-intro.md#concept_64E817EC9F2E4298BAFDCD5B1B3D03F0" format="dita" scope="local"> Data Collection Server (DCS) API Methods and Code</a> </td> 
...
<table id="table_285A1E3D41F245D195FC983A298F89DA"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1">The DIL <a href="../c-dil/dil-class-overview/dil-create.md#reference_F87131F6C1CC4ECCA064B24B91710FD4" format="dita" scope="local"> create</a> method. </td> 
   <td colname="col2"> <p> 
...
<table id="table_E3544AE9796D43408FBEC64CA5B493D8"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <a href="../c-features/audience-marketplace/audience-marketplace.md#concept_3FEC387E18E0492C9ADCB9B4CB11731B" format="dita" scope="local"> Audience Marketplace</a> </td> 
  ...
  <tr> 
   <td colname="col1">Revisions: 
    <ul id="ul_CA72F516D8704B099522158F2440BE6A"> 
     <li id="li_187015C6742C4D2E84380C68FEF7B58E"><a href="../c-features/c-administration/administration-overview.md#task_3327F7C4A9834F1BA5007EDA279D40F2" format="dita" scope="local"> Create Groups</a> </li> 
     <li id="li_65B558E93BA84FA6AE3927C8BD4588FC"><a href="../c-features/c-administration/administration-overview.md#concept_0C02DB9A31DB4519A5AB60B6A361E708" format="dita" scope="local"> Understanding Wild Card Permissions</a> </li> 
    </ul> </td> 
   <td colname="col2"> 
...
<table id="table_E8CD8CF9B9D3439C99AC688AFD712621"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md#concept_49E6F0740E794B07ACD115D10EDEB5AC" format="dita" scope="local"> Inbound Data File Contents: Syntax, Variables, and Examples </a> </p> </td> 
...
<table id="table_A9AF62AC1D434B87BF4CB29BB1FE9EE0"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>New topic. </p> <p>Changed to <a href="../faq/faq-privacy.md#concept_19A401AFC8414994810290011AA10595" format="dita" scope="local"> Privacy and Data Retention FAQ</a> (12/2016). </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_14B4E7BC63394E1F966035B977F90D58"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> <p> <a href="../reference/reporting-file-transfer-timeframe.md#concept_B4863966B22949C19F12A269C4BC2719" format="dita" scope="local"> Reporting and File Transfer Time-Frame Guidelines </a> </p> </td> 
   <td colname="col2"> <p>Updated the times for daily inbound file ingestion and outbound file export. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/reports-dashboard.md#concept_1F19F03D45164D2391F80A083410DC2E" format="dita" scope="local"> Dashboard </a> </p> </td> 
...
<table id="table_A52FC2668EEE4100A71B52267B7215F9"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../faq/faq-inbound-data-ingestion.md#concept_CA81A40C5DD643F899490355C737CE9C" format="dita" scope="local"> Inbound CRM Data Ingestion </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../reporting/general-reports.md#concept_E4686B9B4BE54DFE9599E0868224E027" format="dita" scope="local"> General Reports </a> </p> </td> 
   <td colname="col2"> <p>Added section explaining how numbers in <span class="wintitle"> General Reports</span> are generated. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-dil/dil-modules.md#reference_26B0A55C6F5E40C39057EBA95A1E638E" format="dita" scope="local"> siteCatalyst.init </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p>Profile Merge Customer Enablement </p> </td> 
   <td colname="col2"> <p>Added additional step to explain how to add the use of Declared IDs to DIL and the Mobile SDK. </p> <p>This document has been deprecated and replaced by <a href="../c-features/profile-merge-rules/merge-rules-start.md#concept_396828374D1B48C988655B2ED817F29B" format="dita" scope="local"> Create a Cross-Device Data Source</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-integration/sending-audience-data/batch-data-transfer-explained/inbound-file-contents.md#concept_49E6F0740E794B07ACD115D10EDEB5AC" format="dita" scope="local"> Inbound Data File Contents: Syntax, Variables, and Examples </a> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Updated text and added illustrations. </p> <p>This document has been deprecated and replaced by <a href="../c-features/profile-merge-rules/merge-rules-overview.md#concept_5FCB08A53C4D4C2B82800BC9FD2B8EC9" format="dita" scope="local"> Profile Link</a>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-features/c-segments/recency-and-frequency.md#concept_957D9E1977774D28A98ACEE6035E7B37" format="dita" scope="local"> Recency and Frequency </a> </p> </td> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../c-integration/receiving-audience-data/batch-outbound-transfers/outbound-file-name-contents.md#concept_6D02DD0812A449388359C11D86D619B5" format="dita" scope="local"> Outbound Data File Contents: Syntax and Parameters </a> </p> </td> 
   <td colname="col2"> <p>Added information about removed segments in outbound files. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <a href="../c-integration/receiving-audience-data/batch-outbound-transfers/outbound-template-macros.md#concept_91784732DF6148CF993C3C574270FE2F" format="dita" scope="local"> Outbound Template Macros </a> </p> </td> 
