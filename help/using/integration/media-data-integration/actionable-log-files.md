...
<table id="table_A5A2A10D471C4C9D8DCD88F9C017040C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>The ID of the data source you use to capture DCM data. See <a href="../../features/data-sources/manage-datasources.md#create-data-source"> How to Create a Data Source</a>. </p> </td> 
