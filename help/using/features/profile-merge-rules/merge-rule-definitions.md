...
| Last Authenticated Profiles    | Profile Link Device Graph                           | North America and Canada only                                                                                                                                                                     | Real-time and batch | Yes                   | [Cross-device Targeting](profile-link-use-case.md#cross-device-personalization)         |
...
| All Cross-Device Profiles      | N/A                                                 | Exclusive to [People-Based Destinations](../destinations/people-based-destinations-overview.md) customers | Batch only          | No                   | [People-Based Targeting](merge-rule-targeting-options.md#all-cross-device)              |
