...
1. Data Feed Report Metrics. The Venn diagram (and related metrics) shows you trait overlap data for the last 30 days. See [The Marketplace: About](marketplace-data-buyers.md#about-marketplace) for details.
   * **[!UICONTROL 30 Day Overlapped Uniques]**: The number of unique users in your account that overlap with the users in the provider’s account. For a definition of unique users, see the [Index of IDs in Audience Manager](/help/using/reference/ids-in-aam.md).
