...
uuid: a3cd91f8-4dd2-4225-bb30-9557b627be21
index: y
internal: n
snippet: y
translate: y
...
1. [Create a group](https://support.google.com/dcm/partner/answer/3370419?hl=en&ref_topic=6107456).
   ...
   Name the data sources **Advertiser Analytics: DCM Platform** and **Advertiser Analytics: AAM+DCM Platform.** In the [Create Data Sources](../../../c_features/manage-datasources.md#concept_3B7696B3EC77416492D3B99EBD79EA44) workflow, set the ID type to **Cookie**. Share the IDs of the two new data sources with our internal teams. 1. You can easily create traits from the DCM files you import into [!DNL Audience Manager]. See [Actionable Log Files](../../../c_integration/media-data-integration/actionable-log-files.md#concept_464D49C698A04E26AFD8AA0F640E5EB3) and ask your [!DNL Audience Manager] consultant or Customer Care to enable the feature for you.
