...
| [New SFTP servers](../faq/faq-data-collection.md) | You can now use the new [!DNL SFTP] servers (`ftp-in-gtw` and `ftp-out-gtw`) that use [!DNL AWS SFTP Gateway] over [!DNL S3]. |
