...
| Topic | Description |
|--- |----|
| [Audience Marketplace Billing Examples](/help/using/features/audience-marketplace/marketplace-data-buyers/marketplace-buyer-billing.md#billing-examples) | We added a new example, Case 3, where we detail how billing works for segments with activation and modeling use cases.|
...
| Topic | Description |
|--- |----|
| [Destinations Home Page](/help/using/features/destinations/manage-destinations.md#default-landing-page) | The [Destinations](https://bank.demdex.com/portal/destinations/all) landing page has a new look. Read this page for information about the new layout.|
