...
uuid: 5bb6b862-44f9-4c9f-9a8c-26b76b04a286
index: y
internal: n
snippet: y
translate: y
...
# ID Syncing with Media Optimizer
...
<table id="table_78361E703C5C49418BCDED97B6DD6C9C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Remove all the data sources from <span class="wintitle"> Selected Data Sources for this Container </span> to disable ID syncs with AMO. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>On (regardless of ID service version) </p> </td> 
   <td colname="col2"> <p>A data source syncs with AMO regardless of ID service version when: </p> <p> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>A data source will sync with AMO with ID service version 2.0 (or greater) when: </p> 
...
>[!MORE_LIKE_THIS]
>
>* [ Manage Containers ](t_containers.md#task_61DB5CEECC5049DD8D059C642AC3F967)
