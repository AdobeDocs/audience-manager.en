...
uuid: c6ee0f3b-4eef-4db0-934d-56741c9cf52c
index: y
internal: n
snippet: y
translate: y
    ...
    <ul id="ul_757DEB56E4F849768468F3C166B0D171"> 
     <li id="li_859E1F4F21D645519F150DC512B3EB1A"> <span class="codeph"> type </span>: Trait types identified by a numeric ID. This variable returns: 
      <ul id="ul_C9839266783D42CCADAAC3FEA33BE4D7"> 
       ...
       <li id="li_831FF929BF50434C8804C13E5786DF79"> <span class="codeph"> 3 </span> which identifies a rules-based trait (realtime,; onboarded through the DCS). </li> 
      </ul> </li> 
